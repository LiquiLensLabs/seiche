...
Full project, the terminal UI, and deployment: https://github.com/LiquiLensLabs/seiche
...
See [docs/MCP.md](https://github.com/LiquiLensLabs/seiche/blob/main/docs/MCP.md).
