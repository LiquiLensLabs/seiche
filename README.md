...
(AGPL-3.0-or-later). See [LICENSE](LICENSE). The terminal at seiche.info stays free; if you run
a modified copy as a service, the AGPL asks you to share your changes the same way.

## Funding

Seiche is solo built and self funded. Grant and donation details:
[seiche.info/support.html](https://seiche.info/support.html) · funding manifest:
[seiche.info/funding.json](https://seiche.info/funding.json)
